...
We try to keep it really fast so that it doesn't impact <span class="link-not-tracked">link not tracked</span>, and so a person can also run it whenever they want.
