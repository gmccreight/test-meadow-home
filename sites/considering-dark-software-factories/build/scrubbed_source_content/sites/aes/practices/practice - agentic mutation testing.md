^ [[agentic engineering practice]] - <span class="link-not-tracked">link not tracked</span>

---

### Practice

<span class="link-not-tracked">link not tracked</span> is basically mutation testing that uses the power of the agent to mutate the code in a way that finds problems.
