...
At 8:00 <span class="link-not-tracked">link not tracked</span> is [[digital twin]].  It can run on a classical [[physics engine]].  But the problem is that you have to create the digital twin.
:
...
At 12:00 <span class="link-not-tracked">link not tracked</span> is [[digital nomad]] which uses a [[neural physics engine]]
