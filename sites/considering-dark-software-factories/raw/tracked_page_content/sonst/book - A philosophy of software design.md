page 11 in the conclusion: dependencies, and [[obscurity|obscurities]] accumulate to cause complexity.  Complexity shows up as change amplification, high cognitive load and (the worst)... unknown unknowns.
...
Page 34 [[information hiding can often be improved by making a class slightly larger]]
...
:
Putting the backspace method in the text class was a [[false abstraction]].  Because the person working on the UI really wants to know exactly what happens when the backspace button is pressed. The fact that they need to go look It up in the text class is an [[obscurity]]
...
...
[[seems related]] to [[The lenses mentioned in Andy Matuschak's "prompts" blog post]] but for [[code comments]]
