...
One of the wonderful things about [[static type system]]s is that they can make it possible, and sometimes even easy, to answer questions like “is it possible to write this function?” For an extreme example, consider the following Haskell type signature:
...
```
......
[[instead of weakening the return type, we can strengthen the argument type]]
